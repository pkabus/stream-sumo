...
public class SumoCommand implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 491611330307294600L;

	Command cmd;
	LinkedList<Object> raw;
	public int input1;
	public int input2;
	...
	public SumoCommand(Object input1, Object input2, Object input3, Object[] array) {
		...
		} else if ((Integer) input2 == Constants.CMD_REROUTE_EFFORT
	...
	public SumoCommand(Object input1, Object input2, Object[] array, Object response, Object output_type) {
		...
		if ((Integer) input1 == Constants.CMD_GET_SIM_VARIABLE && (Integer) input2 == Constants.DISTANCE_REQUEST
				&& array.length == 4) {
		...
		} else if ((Integer) input1 == Constants.CMD_GET_SIM_VARIABLE && (Integer) input2 == Constants.DISTANCE_REQUEST
				&& array.length == 5) {
	...
	public boolean equals(Object other) {
		if (!(other instanceof SumoCommand)) {
			return false;
		}

		SumoCommand o = (SumoCommand) other;

		return this.input1 == o.input1 && this.input2 == o.input2 && this.info == o.info && this.input3 == o.input3
				&& this.response == o.response && this.output_type == o.output_type && this.raw.equals(o.raw);
	}
